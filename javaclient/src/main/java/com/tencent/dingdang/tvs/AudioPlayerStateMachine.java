...
public class AudioPlayerStateMachine {
    ...
    public AudioPlayerStateMachine(TVSAudioPlayer audioPlayer, TVSController controller) {
    ...
    private static abstract class AudioPlayerStateTransition
        ...
        public AudioPlayerStateTransition(Set<AudioPlayerState> validStartStates,
                TVSAudioPlayer audioPlayer, TVSController controller) {
    ...
    private static class PlaybackStarted extends AudioPlayerStateTransition {
        ...
        public PlaybackStarted(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
    ...
    private static class PlaybackStopped extends AudioPlayerStateTransition {
        ...
        public PlaybackStopped(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class PlaybackFailed extends AudioPlayerStateTransition {
        ...
        public PlaybackFailed(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class PlaybackFinished extends AudioPlayerStateTransition {
        ...
        public PlaybackFinished(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class ClearQueueAll extends AudioPlayerStateTransition {
        ...
        public ClearQueueAll(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class PlayReplaceAll extends AudioPlayerStateTransition {
        ...
        public PlayReplaceAll(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                              TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class PlaybackPaused extends AudioPlayerStateTransition {
        ...
        public PlaybackPaused(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
    ...
    private static class PlaybackResumed extends AudioPlayerStateTransition {
        ...
        public PlaybackResumed(Set<AudioPlayerState> validStartStates, TVSAudioPlayer audioPlayer,
                TVSController controller) {
            super(validStartStates, audioPlayer, controller);
        }
