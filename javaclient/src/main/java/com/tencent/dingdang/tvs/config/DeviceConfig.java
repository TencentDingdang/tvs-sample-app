...
public class DeviceConfig {
    ...
    public static final String TVS_HOST = "tvsHost";
    ...
    public DeviceConfig(String productId, String dsn, String provisioningMethod,
            ...
            CompanionServiceInformation companionServiceInfo, String tvsHost) {
        ...
        tvsHost = StringUtils.isBlank(tvsHost) ? DEFAULT_HOST : tvsHost;
        try {
            this.tvsHost = new URL(tvsHost);
        } catch (MalformedURLException e) {
            throw new MalformedConfigException(TVS_HOST + " is malformed in your config file.", e);
        }
    ...
    public URL getTvsHost() {
        return tvsHost;
    }


    public void setTvsHost(URL url) {
        tvsHost = url;
    }
    ...
    public static class CompanionAppInformation {
        ...
        public static final String LWT_URL = "lwtUrl";
         ...
         * @param lwtUrl
         */
        public CompanionAppInformation(int localPort, String lwtUrl, String sslKeyStore,
        ...
        public URL getLwtUrl() {
            if (loginWithTencentUrl == null) {
                if (StringUtils.isBlank(lwtUrl)) {
                    throw new MalformedConfigException(LWT_URL + " is blank in your config file.");
                } else {
                    try {
                        loginWithTencentUrl = new URL(lwtUrl);
                    } catch (MalformedURLException e) {
                        throw new MalformedConfigException(
                                LWT_URL + " is malformed in your config file.", e);
                    }
                }
            }
            return loginWithTencentUrl;
        }
        ...
        public JsonObject toJson() {
            JsonObjectBuilder builder = Json
                    ...
                    .add(LWT_URL, getLwtUrl().toString())
        ...
        public boolean isValid() {
            ...
            getLwtUrl(); // Verifies that the url is valid
