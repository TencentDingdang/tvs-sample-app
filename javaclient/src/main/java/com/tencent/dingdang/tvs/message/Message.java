...
import com.tencent.dingdang.tvs.message.Message.MessageDeserializer;
 ...
 * {@link com.tencent.dingdang.tvs.message.response.system.Exception Exception},
 * {@link com.tencent.dingdang.tvs.message.request.Event Event} , or {@link Directive}
 */
...
public abstract class Message {
    ...
    public static class MessageDeserializer extends JsonDeserializer<Message> {
        ...
        private Message createMessage(Header header, JsonNode payload, String rawMessage)
                throws JsonParseException, JsonMappingException, IOException {
            if (TVSAPIConstants.System.NAMESPACE.equals(header.getNamespace())
                    && TVSAPIConstants.System.Exception.NAME.equals(header.getName())) {
                return new TVSExceptionResponse(header, payload, rawMessage);
            } else {
