...
public class CompanionAppAuthManager {
    ...
    /**
     * The current tokens being used to make requests to TVS.
     */
    ...
    /**
     * Requests accessToken and refreshToken from LWT by exchanging information provided by the
        ...
        public void run() {
            ...
            while (tries < TOKEN_REFRESH_RETRY_COUNT) {
                try {
                    ...
                    try {
                        log.error(
                                "There was a problem connecting to the LWT service. Trying again in {} seconds",
                                TOKEN_REFRESH_RETRY_INTERVAL_IN_S);
                        Thread.sleep(TOKEN_REFRESH_RETRY_INTERVAL_IN_S);
                    } catch (InterruptedException ie) {
                        log.error("Interrupted while waiting to retry connecting to LWT", ie);
                    }
                    tries++;
                }
            }
