...
public class HeadlessUI extends BaseUI implements AccessTokenListener {
    ...
    public HeadlessUI(TVSController controller, AuthSetup authSetup, DeviceConfig config)
            throws Exception {
    ...
    private void printHelpText() {
        System.out.println();
        System.out.println("Welcome to TVS! To interact with this app, type one of the following "
