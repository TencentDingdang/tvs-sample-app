...
- (void) postCompanionProvisioningInfo:(NSString * )deviceAddress authCode:(NSString *)authCode clientId:(NSString *)clientId redirectUri:(NSString *)redirectUri sessionId:(NSString *)sessionId;
@end
