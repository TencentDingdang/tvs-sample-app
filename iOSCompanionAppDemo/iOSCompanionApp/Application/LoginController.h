...
@interface LoginController : UIViewController<ProvisioningClientDelegate, TVSAuthDelegate>
...
//微信
@property (strong, nonatomic) IBOutlet UIButton *wxLoginButton;
//QQ
@property (strong, nonatomic) IBOutlet UIButton *qqLoginButton;

@property (strong, nonatomic) IBOutlet UIView *loginPanel;

@property (strong, nonatomic) IBOutlet UITextView *logPanel;

@property (assign, nonatomic) NSString *loginType;
